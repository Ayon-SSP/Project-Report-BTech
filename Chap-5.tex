...
\begin{figure}
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[width=0.8\linewidth]{Home} % Include the first screenshot (Home)
        \caption{Home}
    \end{subfigure}%
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[width=0.8\linewidth]{Notification} % Include the second screenshot (Notification)
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{code.png} % Include the laptop screen screenshot
    \caption{Run Code}
\end{figure}